...
#     # if features has at least 2 column, set 2nd column as gene_id
...
#     # if feature has at least 3 columns, set 3rd column as feature_types
#     if features.shape[1] >= 3:
#         adata.var['feature_types'] = features[2].values
    
#     print(f"obs: {adata.obs.keys()}")
#     return adata
